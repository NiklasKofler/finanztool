...
plist_path="$HOME/Library/LaunchAgents/com.niklas.finanztool.capitalcom-import.plist"
...
sed \
  ...
  "$repo_root/automation/launchd/com.niklas.finanztool.capitalcom-import.plist.template" \
  > "$plist_path"

launchctl bootout "gui/$UID/com.niklas.finanztool.capitalcom-import" 2>/dev/null || true
